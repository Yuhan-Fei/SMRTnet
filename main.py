...
def main():
    ...
    parser.add_argument('--data_dir', type=str, default="./dataset/5.5.1.3_10A_norm_simple_unk_single_O4_ion_ext_new_III_2_42.txt", help='data path')
    ...
    parser.add_argument('--infer_rna_dir', type=str, default="./dataset/mir21_rna.txt", help='infer rna directory')
    parser.add_argument('--infer_drug_dir', type=str, default="./dataset/mir21_drug.txt", help='infer drug directory')
    parser.add_argument('--infer_config_dir', type=str, default="./best_model/config.pkl", help='infer config directory')
    parser.add_argument('--infer_model_dir', type=str, default="./best_model/model_best.pth", help='infer model directory')
