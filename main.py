...
def main():
    ...
    parser.add_argument('--infer_config_dir', type=str, default="./results/config.pkl", help='infer config directory')
    parser.add_argument('--infer_model_dir', type=str, default="./results/model_best.pth", help='infer model directory')
