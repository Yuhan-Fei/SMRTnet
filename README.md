...
- **Step 1:** Please click the link above, then copy the [shared folder](https://drive.google.com/drive/folders/1HQo3o2saY5U9vPqebz4ZdpCVVQXqw0q_?usp=sharing) to your own Google Drive by dragging it into your Drive interface:
...
- The inference of SMRTnet requires **~4G** of GPU memory (with batch_size = 1).
