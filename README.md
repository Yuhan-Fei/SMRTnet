...
cp modeling_esm.py /home/zhangjiasheng/anaconda3/envs/smrtnet2/lib/python3.8/site-packages/transformers/models/esm/modeling_esm.py ## because we modified this file.
```
